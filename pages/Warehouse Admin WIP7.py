...
if uploaded_file is not None:
    ...
    reject_clicked = col1.button("REJECT")
    approve_clicked = col2.button("APPROVE")
    ...
    if reject_clicked or approve_clicked:
        st.write("If you are not satisfied with the content of the IFC file and wish not to merge it with the warehouse database, click REJECT. This will remove all temporary data you have created, including DataFrames and IFC files.")
